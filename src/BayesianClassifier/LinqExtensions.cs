...
internal static class LinqExtensions
{
    ...
    /// </summary>
    private static readonly ConcurrentDictionary<Type, bool> IsGenericCollectionTypeCache = new();
    ...
    public static bool IsGenericCollectionType(this Type type) =>
        IsGenericCollectionTypeCache.GetOrAdd(type, static t => t.GetInterfaces()
            .Any(static ti => ti.IsGenericType && ti.GetGenericTypeDefinition() == typeof (ICollection<>)));
}
